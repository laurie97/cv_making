...
\item{My data analysis experience, natural curiosity and strong mathematical background make me well suited
  to using large data to tackle real-world problems within the Data Analytics team at Criteo.}
\end{itemize}
...
\begin{tabbing}
  ...
  \skill{French}   {Conversational level. Practice through weekly in person conversations with French natives.}
  \skill{Sports}   {Play regularly in a 5-a-side rugby and football team. Keen runner and cyclist.}
