...
\title{\center{Laurie McClymont}} % Print the main header
}
\hspace{2cm} % Horizontal space between the two blocks
\parbox{0.5\textwidth}{ % Second block  
  \begin{tabbing} % Enables tabbing 
    \hspace{2.3cm} \= \hspace{3cm} \= \kill % Spacing within the block
...
\item{My data analysis experience, natural curiosity and strong mathematical background make me well suited
  to a role using large data to tackle real-world problems within the Data Analytics team at Deezer.}
\end{itemize}
...
\begin{tabbing}
  ...
  \skill{Music}    {Played saxophone for several years, performing many times in swing and jazz bands. Also play guitar.\\
                    \>\> In addition, I love listening to a broad range of music, from Glass Animals to Miles Davies and Debussy. }
